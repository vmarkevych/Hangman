(function () {
    ...
    function setup() {
        GameLetters = "abcdefghijklmnopqrstuvwxyz";
        lives = 12;
        words = ["drunk in love", "single ladies","formation", "Hold up", "crazy in love","flawless"];
         messages = {
            win: 'Yay, you are a winner!',
            lose: 'Loser, you suck,Game over!',
            guessed: 'You already guessed that, please try again...',
    ...
    document.getElementById('hangman').onsubmit = function (e) {
        ...
        if (guess) {
            ...
            if (GameLetters.indexOf(guess) > -1) {
